        ...
        <div class="col-sm-6 stretch-card grid-margin">
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="font-weight-bold mb-0">2,409 <span class="text-success h5">4,5%<i class="mdi mdi-arrow-up"></i></span></h3>
              ...
              <div class="table-responsive">
                <table class="table custom-table text-dark">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <img src="../assets/images/faces/face3.jpg" class="me-2" alt="image"> Cecelia Bradley </td>
                      <td>
                        <div class="d-flex">
                    ...
                    <tr>
                      <td>
                        <img src="../assets/images/faces/face7.jpg" class="me-2" alt="image"> Lida Fitzgerald </td>
                      <td>
                        <div class="d-flex">
