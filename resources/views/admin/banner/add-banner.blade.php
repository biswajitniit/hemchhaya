@extends('layouts.admin') @section('title', 'Add Banner') @section('content')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="cmxform" id="addbanner" method="post" action="{{ route('admin.add-banner-post-data') }}" name="addbanner" enctype="multipart/form-data">
                            @csrf
                            <fieldset>
