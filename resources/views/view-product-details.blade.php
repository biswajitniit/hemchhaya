                            ...
                            <div class="shop-details-flex-wrap">
                                <div class="shop-details-nav-wrap">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="item-three-tab" data-toggle="tab" href="#item-three" role="tab" aria-controls="item-three" aria-selected="false"><img src="{{ $product->open_view_image }}" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-lg-5">
                            <div class="shop-details-content">
                                ...
                                <div class="shop-details-meta">
                                    <ul>
                                        <li>Baands : <a href="#">{{ GetProductBrand($product->brand) }}</a></li>
                                        ...
                                        <li>SKU ID : <span>{{ $product->sku }}</span></li>
                                    </ul>
                                </div>
