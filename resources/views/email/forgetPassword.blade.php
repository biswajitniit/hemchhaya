                             ...
                             <tbody>
                                ...
                                <tr>
                                   <td style='text-align: center;background: #FFF;padding:20px 30px;border-radius: 10px;'>
                                      ...
                                      <h4>
                                        <a href="{{ route('reset.password.get', $token) }}" style='color: #FFF;text-align: center;background: #EE5719;padding: 15px 50px;border-radius: 50px;margin: 10px auto;text-decoration: none;display: inline-block;'>
                                         Reset your password.
                                        </a>
                                      </h4>
