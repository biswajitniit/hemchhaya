					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tbody>
								...
								<td>
									<table border="0" cellpadding="0" cellspacing="0" style="width:100%; text-align: center;">
										<tbody>
											<tr>
												<td>
													<img src="{{ asset('/frontend/img/logo/logo.png') }}" alt="" style="height: 120px;">
												</td>
											</tr>
											<tr>
												<td>
                            ...
                            <tr style="border: 1px solid #ddd;display: block; padding: 2% 2% 1%;width: 96%;border-radius: 6px;margin-bottom: 20px;">
								<td>
									<img src="{{ asset('/frontend/img/emailtemplateimage/order-received.png') }}" alt="" style=" width: 100%;">
								</td>
							</tr>
							...
							<tr style="width: 600px;background:url({{ asset('/frontend/img/emailtemplateimage/banne_si.png') }});display: inline-block;border-radius: 5px; height: 100px;">
								<td style="text-align: center;width: 150px;">
									<a href="#" target="_blank">
										<img src="{{ asset('/frontend/img/emailtemplateimage/call_.png') }}" style="height:32px;position: relative;top: 20px;left: 10px;" alt="Call us">
									</a>
								</td>
								<td style="text-align: center;width: 150px;">
									<a href="#" target="_blank">
										<img src="{{ asset('/frontend/img/emailtemplateimage/fb.png') }}" style="height:32px;position: relative;top: 30px;" alt="facebook">
									</a>
								</td>
								<td style="text-align: center;width: 150px;">
									<a href="#" target="_blank">
										<img src="{{ asset('/frontend/img/emailtemplateimage/inst_.png') }}" style="height:32px;position: relative;top: 20px;left: -20px;" alt="Instagram">
									</a>
								</td>

								<td style="text-align: center;width: 100px;">
									<a href="#" target="_blank">
										<img src="{{ asset('/frontend/img/emailtemplateimage/tw_.png') }}" style="height:32px;position: relative;top:40px;left: -20px;" alt="twitter">
									</a>
								</td>
							</tr>
							<tr>
