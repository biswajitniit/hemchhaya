                ...
                <div class="row justify-content-center justify-content-lg-between">
                    <div class="col-md-6 offset-md-3 style_b">
                        ...
                        <div class="contact-wrap-content">
                            <form action="<?php echo e(route('user.save-user')); ?>" name="userregistration" id="userregistration" class="contact-form" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="form-grp">
                                    <label for="name">Your Name <span>*</span></label>
                                    <input type="text" name="name" id="name" placeholder="Your Name" value="<?php echo e(old('name')); ?>" class="validate[required]"/>
                                </div>
                                <div class="form-grp">
                                    <label for="email">Your Email <span>*</span></label>
                                    <input type="email" name="email" id="email" placeholder="Your Email" value="<?php echo e(old('email')); ?>" class="validate[required]"/>
                                </div>
                                <div class="form-grp">
                                    <label for="phone">Your Phone No. <span>*</span></label>
                                    <input type="text" name="phone" id="phone" placeholder="Your Phone No." value="<?php echo e(old('phone')); ?>" class="validate[required]"/>
                                </div>
                                <div class="form-grp">
