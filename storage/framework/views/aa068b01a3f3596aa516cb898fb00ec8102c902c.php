        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="cmxform" id="editbrand" method="post" action="<?php echo e(route('admin.edit-brand-post')); ?>" name="editbrand" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="brandid" value="<?php echo e($brand->id); ?>">
                <input type="hidden" name="brand_image_old_file_name" value="<?php echo e($brand->brand_image_name); ?>">
                <input type="hidden" name="brand_image_old_path" value="<?php echo e($brand->brand_image_path); ?>">
                <fieldset>
                    <div class="form-group">
                        ...
                        <select name="category_id" class="js-example-basic-single" style="width: 100%;">
                            ...
                            <option value="<?php echo e($rowcategory->id); ?>" <?php if($rowcategory->id == $brand->category_id): ?> selected="selected" <?php endif; ?>><?php echo e($rowcategory->category_name); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sub_category_id" class="subcategory" style="width: 100%;">
                            ...
                            <?php $getcatid = GetSubcategoryBycatid($brand->category_id); ?> <?php $__currentLoopData = $getcatid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowsubcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rowsubcat->id); ?>" <?php if($rowsubcat->id == $brand->sub_category_id): ?> selected="selected" <?php endif; ?>><?php echo e($rowsubcat->sub_category_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sub_category_item_id" class="subcategory" style="width: 100%;">
                            <option value="">Select Sub Category</option>
                            <?php $getsubcatitemid = GetSubcategoryitemBysubcatid($brand->sub_category_id); ?> <?php $__currentLoopData = $getsubcatitemid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowsubcatitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($rowsubcatitem->id); ?>" <?php if($rowsubcatitem->id == $brand->sub_category_item_id): ?> selected="selected" <?php endif; ?>><?php echo e($rowsubcatitem->sub_category_item_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="brand_name" class="form-control" name="brand_name" type="text" value="<?php echo e($brand->brand_name); ?>" />
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <img src="<?php echo e($brand->brand_image_path); ?>" name="brandimage" style="width: 200px; height:auto;"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-check">
                                <label class="form-check-label"> <input type="radio" class="form-check-input" name="status" id="status1" value="1" <?php if($brand->status == 1): ?> checked <?php endif; ?>> Active </label>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-check">
                                <label class="form-check-label"> <input type="radio" class="form-check-input" name="status" id="status2" value="2" <?php if($brand->status == 2): ?> checked <?php endif; ?>> InActive </label>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH E:\webdev\hemchhaya\resources\views/admin/brand/edit-brand.blade.php ENDPATH**/ ?>