    ...
    <div class="content-wrapper">
      <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.brand')); ?>">Brands</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="cmxform" id="addbrand" method="post" action="<?php echo e(route('admin.add-brand-post-data')); ?>" name="addbrand" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <fieldset>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/admin/brand/add-brand.blade.php ENDPATH**/ ?>