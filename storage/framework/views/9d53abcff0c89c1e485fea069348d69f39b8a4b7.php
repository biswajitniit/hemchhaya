            ...
            <div class="row flex-grow">
              <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left p-5">
                  ...
                  <form action="<?php echo e(route('vendorLoginPost')); ?>" name="vendorlogin" id="vendorlogin" class="pt-3" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH E:\webdev\hemchhaya\resources\views/vendor/signin/signin.blade.php ENDPATH**/ ?>