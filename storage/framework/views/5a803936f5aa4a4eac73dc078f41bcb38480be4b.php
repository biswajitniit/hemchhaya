                ...
                <div class="row justify-content-center justify-content-lg-between">
                    <div class="col-md-6 offset-md-3 style_b">
                        ...
                        <div class="contact-wrap-content">
                            ...
                            <form action="<?php echo e(route('user.loginpost')); ?>" name="userlogin" id="userlogin" class="contact-form" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="form-grp">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <p>Need help? <a href="<?php echo e(route('forget.password.get')); ?>">Forgot Password</a></p>
                                    </div>
                                </div>
                            </form>
                            <hr />
