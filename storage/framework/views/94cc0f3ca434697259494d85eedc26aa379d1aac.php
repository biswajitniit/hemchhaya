...
<?php $__env->startSection('title', 'Brand Search'); ?>
...
<div class="main-panel">
    <div class="content-wrapper pb-0">
        <div class="page-header">
            <h3 class="page-title">Search brand</h3>
            <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                <button type="button" onclick="location.href='<?php echo e(route('admin.add-brand')); ?>'" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                  <i class="mdi mdi-plus-circle"></i> Add Brand </button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 stretch-card grid-margin">
                <div class="card">
                    <form action="<?php echo e(route('admin.brand-list-search')); ?>"  name="search-brand-list" id="search-brand-list" method="GET">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Brands's</h4>
                <div class="row">
                    <div class="col-12">
        ...
        // DataTable
            $('#my-table').DataTable({
                ...
                "ajax": {
                    ...
                    url : "<?php echo e(route('admin.search-brand-list-datatable')); ?>",
                    type : 'GET',
                },
                columns: [
                        {data: 'brand_name' },
                        {
                            ...
                            render: function (data, type, row){
                                if(data != ""){
                                    return '<img src="'+data+'" width="200" height="auto"/>';
                                }else{
                                    return '<img src="noimg.jpg" width="200" height="auto"/>';
                                }
                            },
                        },
                        {
                        ...
                        },
                       {
                            data: 'action',
                            render: function (data, type, row){
                                return '<a href="<?php echo url("admin/edit-brand") ?>/'+data+'" onclick="geturldata(event)" title="Edit Brand"><i class="mdi mdi-table-edit"></i></a> | <a href="<?php echo url("admin/brand-trash")?>/'+data+'" title="Trash Brand" onclick="confirmMsg(event)"><i class="mdi mdi-delete-forever"></i></a>';
                            },
                        },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/admin/brand/brand-list-search.blade.php ENDPATH**/ ?>