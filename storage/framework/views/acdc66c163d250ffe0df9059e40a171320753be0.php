        ...
        // DataTable
            $('#my-table').DataTable({
                ...
                "ajax": {
                    ...
                    url : "<?php echo e(route('admin.searchvariationajax')); ?>",
                    type : 'GET',
                },
                columns: [
                        {data: 'variation_name' },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/admin/variation/variation-list-search.blade.php ENDPATH**/ ?>