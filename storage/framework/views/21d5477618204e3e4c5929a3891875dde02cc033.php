        ...
        // DataTable
            $('#my-table').DataTable({
                ...
                "ajax": {
                    ...
                    url : "<?php echo e(route('vendor.searchvariationajax')); ?>",
                    type : 'GET',
                },
                columns: [
                        {data: 'variation_name' },
...
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/vendor/variation/variation-list-search.blade.php ENDPATH**/ ?>