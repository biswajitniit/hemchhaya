                                    ...
                                    <td style="width:40%">
                                        <div class="media">
                                            <a href="javascript:void(0)" data-rel="lightcase">
                                                <img src="<?php echo e(Getimageurllarge($row->product_id)); ?>" width="100" height="auto">
                                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/dashboardarea/view-order-details.blade.php ENDPATH**/ ?>