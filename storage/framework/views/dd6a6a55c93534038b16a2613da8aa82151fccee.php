                             ...
                             <tbody>
                                   ...
                                   <td>
                                      <table border='0' cellpadding='0' cellspacing='0' style='width:100%; text-align: center;'>
                                         <tbody>
                                            <tr>
                                               <td>
                                                  <img src=".url("frontend/img/emailtemplateimage/logo.png")." alt=''>
                                               </td>
                                            </tr>
                                ...
                                <tr>
                                   <td style='text-align: center;background: #FFF;padding:20px 30px;border-radius: 10px;'>
                                      ...
                                      <h4>
                                        <a href="<?php echo e(route('reset.password.get', $token)); ?>" style='color: #FFF;text-align: center;background: #EE5719;padding: 15px 50px;border-radius: 50px;margin: 10px auto;text-decoration: none;display: inline-block;'>
                                         Reset your password.
                                        </a>
                                      </h4>
...
<?php /**PATH E:\webdev\hemchhaya\resources\views/email/forgetPassword.blade.php ENDPATH**/ ?>