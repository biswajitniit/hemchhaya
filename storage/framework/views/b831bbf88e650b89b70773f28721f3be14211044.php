                ...
                <div class="col-lg-6">
                    <div class="shop-details-content">
                        ...
                        <div class="shop-details-price">
                            <h2 class="price"><i class="fas fa-rupee-sign"></i>9.99</h2>
                        ...
                        <div class="row pt-4 pb-4">
                            <div class="col-6">
                                ...
                                <ul class="swatch-quantity">
                                    <li class="active"><a href="#">1 TON</a></li>
                                    <li><a href="#">1.5 TON</a></li>
                                    <li><a href="#">2 TON</a></li>
                                    <li><a href="#">3.5 TON</a></li>
                                    <li><a href="#">4 TON</a></li>
                                </ul>
                            </div>
                            <div class="col-6">
                                <p>Star Rating</p>
                            ...
                            <div class="col-6">
                                ...
                                <ul class="swatch-quantity">
                                    <li class="active">
                                        <a href="#">500 g <small>@92/kg</small></a>
                                    </li>
                                    <li>
                                        <a href="#">1 kg <small>@91/kg</small></a>
                                    </li>
                                    <li>
                                        <a href="#">2 kg <small>@90/kg</small></a>
                                    </li>
                                    <li>
                                        <a href="#">5 kg <small>@88/kg</small></a>
                                    </li>
                                    <li>
                                        <a href="#">10 kg <small>@85/kg</small></a>
                                    </li>
                                </ul>
                            </div>
                        </div>

                        <p>Organic food is food produced by methods complying with the standards of Rrganic farming. Standards vary Lorem ipsum dolor sit amet, consectetur adipiscing worldwide, but organic farming.</p>
                        ...
                        <div class="shop-details-bottom spec_">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <p>
                                        1 Indoor Unit, 1 Outdoor Unit, Installation Cu Pipe, Installation Wire, Remote, Indoor Mounting, Screw and 2 AAA Batteries
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-12">
                    <div class="product-desc-wrap">
                        <ul class="nav nav-tabs" id="myTabTwo" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="val-tab" data-toggle="tab" href="#val" role="tab" aria-controls="val" aria-selected="false">Viewers Also Like</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="false">Product Reviews</a>
                            </li>
                        </ul>
                                ...
                                <div class="product-desc-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9 col-md-7">
                                            ...
                                            <p>
                                                Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
