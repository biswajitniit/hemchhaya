        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                ...
                <form class="cmxform" id="addvariationitem" method="post" action="<?php echo e(route('admin.add-variationitem-post-data')); ?>" name="addvariationitem">
                    <?php echo csrf_field(); ?>
                    <fieldset>
    ...
    <script type="text/javascript">
        ...
        $("document").ready(function () {
            ...
            $('select[name="sub_category_item_id"]').on('change', function () {
                ...
                if (subcatitemId) {
                    $.ajax({
                        url: "<?php echo e(route('admin.getvariationBysubcategoryitem')); ?>",
                        type: "POST",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/admin/variationitems/add-variationitem.blade.php ENDPATH**/ ?>