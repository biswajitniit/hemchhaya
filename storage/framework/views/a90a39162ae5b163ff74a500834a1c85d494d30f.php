...
<?php $__env->startSection('title', 'Salesanta | About Us'); ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-7">
                                <div class="ingredients-img">
                                    <img src="<?php echo e(asset('frontend/img/images/ingredients_img.jpg')); ?>" alt="">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="newsletter-wrap">
                                    ...
                                    <img src="<?php echo e(asset('frontend/img/images/newsletter_shape01.png')); ?>" alt="" class="newsletter-shape top-shape wow fadeInDownBig" data-wow-delay=".3s">
                                    <img src="<?php echo e(asset('frontend/img/images/newsletter_shape02.png')); ?>" alt="" class="newsletter-shape bottom-shape wow fadeInUpBig" data-wow-delay=".3s">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-5">
                                <div class="online-support-img">
                                    <img src="<?php echo e(asset('frontend/img/images/support_img.png')); ?>" alt="">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\hemchhaya\resources\views/about-us.blade.php ENDPATH**/ ?>